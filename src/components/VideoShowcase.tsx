    ...
    <section className="py-20 bg-gradient-to-b from-[#0a1628] to-[#0f2039] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/15 text-primary text-xs font-semibold tracking-widest uppercase mb-4">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Organized by Viab Tech at Uhuru Heights, Bibi Titi Mohamed Street, Dar es Salaam
          </p>
        </div>
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div
            className="relative rounded-2xl overflow-hidden shadow-2xl shadow-primary/20 cursor-pointer group"
          ...
          >
              ...
              {!isPlaying && (
                <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/70 to-transparent">
                  ...
                  <p className="text-white text-lg sm:text-xl font-bold">
                    Grand Launch — Service Centre Inauguration
                  </p>
                </div>
              )}
            </div>
            ...
            {isPlaying && (
              <button
                onClick={toggleMute}
                className="absolute bottom-4 right-4 w-10 h-10 rounded-full bg-black/40 backdrop-blur-sm flex items-center justify-center text-white hover:bg-black/60 transition-colors z-10"
