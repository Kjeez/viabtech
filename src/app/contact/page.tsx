          ...
          <div className="grid lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="relative bg-white rounded-[2rem] px-8 py-6 border border-gray-100 shadow-[0_10px_30px_rgba(0,159,227,0.04)] hover:shadow-lg transition-all overflow-hidden group">
                ...
                <div className="flex items-start gap-3">
                  <MapPin size={18} className="text-gray-400 shrink-0 mt-0.5" />
                  <a href="https://maps.google.com/?cid=7711297827740443260&g_mp=CiVnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLkdldFBsYWNlEAIYASAA&hl=en&gl=IN&source=embed" target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-gray-500 leading-relaxed hover:text-[#CC0000] transition-colors">
